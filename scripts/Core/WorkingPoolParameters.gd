...
static func _default() -> WorkingPoolParameters:
	var parameters = WorkingPoolParameters.new()

	var y = 0.095

	parameters.append_positions(1, [Vector3(0.33, y, 0), Vector3(0.66, y, 0)])

	parameters.append_positions(
		2, [Vector3(1.2, y, 0), Vector3(2.4, y, 0), Vector3(3.6, y, 0), Vector3(4.8, y, 0)]
	)
